...
const PostDetail = () => {
    ...
    const onApplyCV = async (event) => {
        ...
        console.log(cvSubmit.mediaId)
        if (cvSubmit.mediaId.length === 0) {
            swal('Warning', 'Please choose your cv !', 'warning')
            return
        }
        try {
            ...
            if (response && response.success) {
                ...
                swal('Success', 'Apply success, the employer will contact you soon !', 'success')
            } else {
                                ...
                                <div className="job-header-info">
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12 company-name">
                                            <span className="name">
                                                <a href={'/employer/profile/' + post.employer.id} title="View Employer Profile !" target="_blank" rel="noreferrer">
                                                    {post.employer.name}
                                                </a>
                                            </span>
                                        </div>
                                ...
                                <div className="col-lg-3 col-md-3 col-btn col-btn-save-section ">
                                    <div className="row">
                                        <div className="col-xs-6 col-xs-push-6 col-md-12 col-md-push-0">
                                            ...
                                            <Button className="btn btn-primary btn-block btn-apply track-event" variant="warning" onClick={onApplyCV}>
                                                Apply now
                                            </Button>
